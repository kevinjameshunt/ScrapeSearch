...
class TextResultsViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: TextSearchResultCell.reuseIdentifier, for: indexPath) as! TextSearchResultCell
...
extension TextResultsViewController: SearchResultsReceiver {
